                ...
                <div className='space-y-6'>
                  <div className='flex justify-between items-top'>
                    <div className='space-y-4'>
                      <div>
                        ...
                        <p className='font-bold text-2xl'>
                          {" "}
                          Invoice{" "}
                          <span className='text-3xl text-slate-500 font-normal'>
                            # {myInvoice.invoiceId}
                          </span>
                        </p>
                      </div>
                    ...
                    <div className='space-y-2'>
                      {myInvoice.deuBill > 0 ? (
                        <h2 className='py-3 text-center my-4 uppercase text-red-400 font-extrabold outline-dotted outline-4 outline-red-500'>
                          Unpaid
                        </h2>
                      ) : (
                        <h2 className='py-3 text-center my-4 uppercase text-green-400 font-extrabold outline-dotted outline-4 outline-green-500'>
                          paid
                        </h2>
                      )}
                      <div>
              ...
              <div className='p-9 border-3 border-gray-200 border-dotted'>
                <div className='space-y-3'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <p className='font-bold text-black text-lg'>
                      {" "}
                      {myInvoice.deuBill ? myInvoice.deuBill : "Paid"}
                      {myInvoice.deuBill && (
                        <span
