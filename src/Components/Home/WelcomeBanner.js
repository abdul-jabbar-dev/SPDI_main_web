...
<>
    <div className='flex flex-col relative z-20 items-center justify-center text-white '>
        <div className="container  absolute z-30">
            <h2 className='  md:text-5xl text-2xl  font-semibold md:text-left text-center'>Best Polytechnic Institute In
                Gazipur</h2>
            <p className='md:text-2xl text-md md:mb-4'>At SPDI, you'll explore new ideas while learning more about
                yourself. </p>
